...
export const metadata: Metadata = {
  ...
  description:
    'Reserva canchas de pádel, tenis, fútbol y más en segundos. La plataforma deportiva más completa de Colombia. Powered by Peralta Prime.',
  keywords: [
    'pádel Colombia',
    'reservar cancha',
    'tenis Cúcuta',
  ...
  openGraph: {
    ...
    description:
      'Reserva canchas de pádel, tenis, fútbol y más en segundos. Powered by Peralta Prime.',
    images: [
      {
        url: '/og-image.jpg',
        width: 1200,
